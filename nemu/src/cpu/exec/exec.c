...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    EX(inc), EMPTY, IDEX(gp5_E, call), EMPTY,
    IDEX(gp5_E, jmp), EMPTY, EX(push), EMPTY)
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x3c */	EMPTY, IDEX(cmp_I, cmp), EMPTY, EMPTY,
  ...
  /* 0x5c */	EMPTY, IDEX(pop_r, pop), IDEX(pop_r, pop), IDEX(pop_r, pop),
  ...
  /* 0xe8 */	IDEX(call_I, call), IDEX(J, jmp), EMPTY, IDEXW(J, jmp, 1),
  ...
  /* 0x94 */	IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), EMPTY, IDEXW(setcc_E, setcc, 1),
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x9c */	IDEXW(setcc_E, setcc, 1), EMPTY, EMPTY, EMPTY,
